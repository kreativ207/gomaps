...
<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;key=AIzaSyDWDXx6_ARm8vII9La01UGGRb3GcSDrpJw"
 ...
 //<![CDATA[
  ...
  function load() {
    ...
    <div id="map" style="width: 800px; height: 600px; margin: 0 0 20px 0"></div>
    <?php if(count($links) >= 1): ?>
        <h3 style="text-align: center">Navigation from Markers</h3>
        <?php else: ?>
        <h3 style="text-align: center">No Markers</h3>
    <?php endif; ?>
    <ul>
